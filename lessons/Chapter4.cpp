...
int main(){
    cv::Mat img(512, 512, CV_8UC3, cv::Scalar(255, 255, 255));      //生成空白图
    ...
    cv::putText(img, "qtl's conmputer", cv::Point(160, 262),cv::FONT_HERSHEY_DUPLEX, 0.75, cv::Scalar(0, 69, 255), 2);
